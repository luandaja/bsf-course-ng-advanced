...
@NgModule({
	declarations: [TableBoardComponent, StoryComponent, BoardCardsComponent, CardComponent, BoardCardComponent, PlayersComponent, VoteEditorComponent, StartGameComponent, BoardComponent],
	imports: [
		CommonModule,
		BoardRoutingModule,
		//	CoreModule,
